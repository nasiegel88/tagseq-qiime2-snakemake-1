...
#MANIFEST['absolute-filepath'] = NEWPAT + MANIFEST['filename']    
...
if LONGITUDINAL == 'yes':
    ...
    include: 'rules/06-longitudinal.smk'
...
include: "rules/01-qc.smk"
include: "rules/02-dada2.smk"
include: "rules/03-phylogeny.smk"
include: "rules/04-picrust2.smk"
include: "rules/05-differential.smk"
