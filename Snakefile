...
"weighted_unifrac_viz = OUTPUTDIR + '/qiime2/asv/core-metrics-results/' + PROJ + 'NALYSIS + '-weighted-unifrac-group-site-significance.qzv'",
"unweighted_unifrac_viz = OUTPUTDIR + '/qiime2/asv/core-metrics-results/' + PROJ + 'NALYSIS + '-unweighted-unifrac-group-site-significance.qzv'",
...
"bray_curtis_signif = OUTPUTDIR + '/qiime2/asv/core-metrics-results/' + PROJ + 'NALYSIS + '-bray-curtis-group-significance.qzv'",
...
if LONGITUDINAL == 'no':
  ...
  print('adding files for snakemake!')
